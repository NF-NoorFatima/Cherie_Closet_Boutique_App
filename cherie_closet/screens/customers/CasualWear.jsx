...
const CasualWear = ({ navigation }) => {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      const response = await fetch('https://cheriecloset-default-rtdb.firebaseio.com/Casual.json');
      if (!response.ok) {
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.container}>
        <View style={styles.header}>
          <Text style={styles.heading}>Casual Collection</Text>
        </View>
          ...
          <FlatList
            ...
            ListEmptyComponent={
              <View style={styles.emptyContainer}>
                <Text style={styles.emptyText}>No casual wear found in the collection.</Text>
              </View>
            }
          />
        )}
