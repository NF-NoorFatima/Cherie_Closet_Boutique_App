...
const Signature = ({ navigation }) => {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      const response = await fetch('https://cheriecloset-default-rtdb.firebaseio.com/Signature.json');
      if (!response.ok) {
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.container}>
        <View style={styles.header}>
          <Text style={styles.heading}>Signature Collection</Text>
        </View>
          ...
          <FlatList
            ...
            ListEmptyComponent={
              <View style={styles.emptyContainer}>
                <Text style={styles.emptyText}>No signature pieces found in the collection.</Text>
              </View>
            }
          />
        )}
