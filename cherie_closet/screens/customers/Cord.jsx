...
const Cord = ({ navigation }) => {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      const response = await fetch('https://cheriecloset-default-rtdb.firebaseio.com/Cords.json');
      if (!response.ok) {
      ...
      for (const key in data) {
        ...
        formattedData.push({
          ...
          price: item.price || 0,
          tag: item.tag || 'N/A',
          category: item.category || 'Co-ord Sets',
        });
      }
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.container}>
        <View style={styles.header}>
          <Text style={styles.heading}>Co-ord Sets</Text>
        </View>
          ...
          <FlatList
            ...
            ListEmptyComponent={
              <View style={styles.emptyContainer}>
                <Text style={styles.emptyText}>No co-ord sets found in the collection.</Text>
              </View>
            }
          />
        )}
