...
const FormalWear = ({ navigation }) => {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      const response = await fetch('https://cheriecloset-default-rtdb.firebaseio.com/Formal.json');
      if (!response.ok) {
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.container}>
        <View style={styles.header}>
          <Text style={styles.heading}>Formal Collection</Text>
        </View>
          ...
          <FlatList
            ...
            ListEmptyComponent={
              <View style={styles.emptyContainer}>
                <Text style={styles.emptyText}>No formal wear found in the collection.</Text>
              </View>
            }
          />
        )}
