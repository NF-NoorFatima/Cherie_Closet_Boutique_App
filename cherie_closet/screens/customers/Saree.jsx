...
const Saree = ({ navigation }) => {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      const response = await fetch('https://cheriecloset-default-rtdb.firebaseio.com/Saree.json');
      if (!response.ok) {
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.container}>
        <View style={styles.header}>
          <Text style={styles.heading}>Saree Collection</Text>
        </View>
          ...
          <FlatList
            ...
            ListEmptyComponent={
              <View style={styles.emptyContainer}>
                <Text style={styles.emptyText}>No sarees found in the collection.</Text>
              </View>
            }
          />
        )}
