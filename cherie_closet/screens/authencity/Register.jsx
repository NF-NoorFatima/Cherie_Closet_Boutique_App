  ...
  async function Posts() {
    try {
      ...
      if (response.ok) {
        ...
        await fetch(`https://cheriecloset-default-rtdb.firebaseio.com/Users/${localId}.json`, {
      ...
      >
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.container}>
            <Text style={styles.title}>Join Cherie Closet</Text>
            <Text style={styles.subtitle}>Create an account to experience luxury fashion</Text>
